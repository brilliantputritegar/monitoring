            ...
            {showSearchInput ? (
              ...
              <>
                {isCustomTitleSearch ? (
                  ...
                  <p className="mx-auto -translate-x-1/3">{titleSearch}</p>
                )}
              </>
            )}
          </div>
        ...
        >
          ...
          <div>
            ...
            <div className="flex flex-col space-y-4">
              <h2 className="font-medium text-neutral-neutral03 text-xl">
                Menu
              </h2>
              <a href="/dashboard" className="font-medium">
                Dashboard
              </a>
              <a href="/report" className="font-medium">
                Report
              </a>
              <a href="/device" className="font-medium">
                Device
              </a>
              <h2 className="font-medium text-neutral-neutral03 text-xl">
                Setting
              </h2>
              <a href="/alert" className="font-medium">
                Alert
              </a>

              <a href="/user" className="font-medium">
                User
              </a>
              <a href="/threshold" className="font-medium">
                Threshold
              </a>
              <a href="/indicator" className="font-medium">
                Indicator
              </a>
            </div>
          </div>
