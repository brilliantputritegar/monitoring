const Button = ({
  ...
  let colorClass =
    variant === "primary"
      ? "bg-primary-limegreen04 hover:bg-primary-limegreen05  text-white focus:ring-primary-limegreen04 focus:ring-offset-primary-limegreen03 focus:ring-2 focus:ring-offset-2"
      : "bg-white hover:bg-gray-300 border border-primary-limegreen04 focus:bg-gray-300";
